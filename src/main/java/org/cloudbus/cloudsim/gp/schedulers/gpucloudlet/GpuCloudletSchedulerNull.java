...
final class GpuCloudletSchedulerNull implements GpuCloudletScheduler {
    ...
    @Override
    public GpuCloudlet cloudletFail(Cloudlet cloudlet) {
        return GpuCloudlet.NULL;
    }

    @Override
    public GpuCloudlet cloudletCancel(Cloudlet cloudlet) {
        return GpuCloudlet.NULL;
    }
    ...
    @Override
    public GpuCloudletScheduler addOnCloudletResourceAllocationFail(
            EventListener<CloudletResourceAllocationFailEventInfo> listener) {
        return this;
    }

    @Override
    public boolean removeOnCloudletResourceAllocationFail(
            EventListener<CloudletResourceAllocationFailEventInfo> listener) {
        return false;
    }
}
