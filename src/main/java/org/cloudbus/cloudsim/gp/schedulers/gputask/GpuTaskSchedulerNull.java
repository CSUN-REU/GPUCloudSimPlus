...
public class GpuTaskSchedulerNull implements GpuTaskScheduler {
    ...
    @Override
    public GpuTask gpuTaskFail(GpuTask gpuTask) {
        return GpuTask.NULL;
    }

    @Override
    public GpuTask gpuTaskCancel(GpuTask gpuTask) {
        return GpuTask.NULL;
    }

    @Override
    public boolean gpuTaskReady(GpuTask gpuTask) {
        return false;
    }

    @Override
    public boolean gpuTaskPause(GpuTask gpuTask) {
        return false;
    }
    ...
    @Override
    public double gpuTaskSubmit(GpuTask gpuTask, double fileTransferTime) {
        return 0.0;
    }

    @Override
    public double gpuTaskSubmit(GpuTask gpuTask) {
        return 0.0;
    }
    ...
    @Override
    public void deallocateCoresFromVGpu(long pcoreToRemove) { /**/ }
    ...
    @Override
    public double getRequestedGpuPercent(double time) {
        return 0.0;
    }

    @Override
    public double getAllocatedGpuPercent(double time) {
        return 0.0;
    }
    ...
    @Override
    public void addGpuTaskToReturnedList(GpuTask gpuTask) { /**/ }
