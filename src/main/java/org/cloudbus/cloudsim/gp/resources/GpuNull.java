...
final class GpuNull implements Gpu {
    ...
    @Override
    public GpuSuitability getSuitabilityFor(VGpu vgpu) {
    ...
    @Override
    public Gpu setActive(boolean activate) {
        return this;
    }
    ...
    @Override
    public boolean addMigratingInVGpu(VGpu vgpu) {
        return false;
    }
    ...
    @Override
    public boolean addVGpuMigratingOut(VGpu vgpu) {
        return false;
    }

    @Override
    public boolean removeVGpuMigratingOut(VGpu vgpu) {
        return false;
    }
    ...
    @Override
    public void removeMigratingInVGpu(VGpu vgpu) { /**/ }
    ...
    @Override
    public double getBusyCoresPercent(boolean hundredScale) {
        return 0.0;
    }
    ...
    @Override
    public Gpu setVGpuScheduler(VGpuScheduler vgpuScheduler) {
        return this;
    }
    ...
    @Override
    public Gpu setIdleShutdownDeadline(double deadline) {
        return this;
    }
    ...
    @Override
    public GpuSuitability createVGpu(VGpu vgpu) {
        return GpuSuitability.NULL;
    }

    @Override
    public void destroyVGpu(VGpu vgpu) { /**/ }

    @Override
    public GpuSuitability createTemporaryVGpu(VGpu vgpu) {
        return GpuSuitability.NULL;
    }

    @Override
    public void destroyTemporaryVGpu(VGpu vgpu) { /**/ }

    @Override
    public void destroyAllVGpus() { /**/ }

    @Override
    public Gpu addOnStartupListener(EventListener<GpuEventInfo> listener) {
        return this;
    }

    @Override
    public boolean removeOnStartupListener(EventListener<GpuEventInfo> listener) {
        return false;
    }

    @Override
    public Gpu addOnShutdownListener(EventListener<GpuEventInfo> listener) {
        return Gpu.NULL;
    }

    @Override
    public boolean removeOnShutdownListener(EventListener<GpuEventInfo> listener) {
        return false;
    }

    @Override
    public Gpu addOnUpdateProcessingListener(
            EventListener<GpuUpdatesVgpusProcessingEventInfo> listener) {
        return Gpu.NULL;
    }
    ...
    @Override
    public Gpu setLazySuitabilityEvaluation(boolean lazySuitabilityEvaluation) {
        return this;
    }
