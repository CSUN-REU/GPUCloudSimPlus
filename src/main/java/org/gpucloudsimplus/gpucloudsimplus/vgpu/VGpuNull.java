...
public class VGpuNull implements VGpu {
    ...
    @Override
    public void addStateHistoryEntry(VGpuStateHistoryEntry entry) {/**/}
    ...
    @Override
    public void notifyOnGpuDeallocationListeners(Gpu deallocatedGpu) {/**/}
    ...
    @Override
    public double getGpuCoreUtilization(double time) {
        return 0;
    }

    @Override
    public double getExpectedGpuCoreUtilization(double vmCpuUtilizationPercent) {
        return 0;
    }
    ...
    @Override
    public double getTotalCoreMipsUtilization(double time) {
        return 0.0;
    }
    ...
    @Override
    public VGpu setStopTime(double stopTime) {
        return this;
    }
    ...
    @Override
    public boolean isSuitableForGpuTask(GpuTask gpuTask) {
        return false;
    }
    ...
    @Override
    public VGpu setBw(long bwCapacity) {
        return this;
    }

    @Override
    public VGpu setGpu(Gpu gpu) {
        return this;
    }
    ...
    @Override
    public VGpu setGddram(long ram) {
        return this;
    }
    ...
    @Override
    public VGpu setGpuTaskScheduler(GpuTaskScheduler gpuTaskScheduler) {
        return this;
    }
    ...
    @Override
    public VGpu setDescription(String description) {
        return this;
    }
    ...
    @Override
    public VGpu addOnCreationFailureListener(
            EventListener<VGpuVideocardEventInfo> listener) {
        return this;
    }

    @Override
    public void notifyOnCreationFailureListeners(Videocard failedVideocard) { /**/ }

    @Override
    public boolean removeOnCreationFailureListener(
            EventListener<VGpuVideocardEventInfo> listener) {
        return false;
    }

    @Override
    public VGpu setStartTime(double startTime) {
        return this;
    }
