...
final class GpuTaskNull implements GpuTask {
    ...
    @Override
    public double getUtilizationOfGpu(double time) {
        return 0.0;
    }
    ...
    @Override
    public double getUtilizationOfGddram(double time) {
        return 0.0;
    }
    ...
    @Override
    public GpuTask setPriority(int priority) {
        return this;
    }

    @Override
    public GpuTask setBlockLength(long length) {
        return GpuTask.NULL;
    }

    @Override
    public GpuTask setFileSize(long fileSize) {
        return GpuTask.NULL;
    }

    @Override
    public GpuTask setOutputSize(long outputSize) {
        return GpuTask.NULL;
    }
    ...
    @Override
    public GpuTask setNumberOfCores(long numberOfPes) {
        return GpuTask.NULL;
    }
    ...
    @Override
    public GpuTask setUtilizationModelGpu(UtilizationModel utilizationModelCpu) {
        return GpuTask.NULL;
    }

    @Override
    public GpuTask setUtilizationModelGddram(UtilizationModel utilizationModelRam) {
        return GpuTask.NULL;
    }
    ...
    public boolean removeOnUpdateProcessingListener(
            EventListener<GpuTaskVGpuEventInfo> listener) {
        return false;
    }

    @Override
    public GpuTask addOnUpdateProcessingListener(
            EventListener<GpuTaskVGpuEventInfo> listener) {
        return GpuTask.NULL;
    }
    ...
    @Override
    public int compareTo(GpuTask gpuTask) {
        return 0;
    }
    ...
    //}
    @Override
    public GpuTask reset() {
        return this;
    }

    @Override
    public GpuTask setLifeTime(final double lifeTime) {
        return this;
    }
