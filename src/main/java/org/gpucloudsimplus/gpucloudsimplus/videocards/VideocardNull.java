...
public class VideocardNull implements Videocard {
    ...
    @Override
    public Videocard setPcieBwProvisioner(VideocardBwProvisioner pcieBwProvisioner) {
        return this;
    }
    ...
    @Override
    public <T extends Gpu> Videocard addGpuList(List<T> gpuList) {
        return this;
    }

    @Override
    public <T extends Gpu> Videocard addGpu(T gpu) {
        return this;
    }

    @Override
    public <T extends Gpu> Videocard removeGpu(T gpu) {
        return this;
    }
    ...
    @Override
    public Videocard setSchedulingInterval(double schedulingInterval) {
        return this;
    }
    ...
    @Override
    public Videocard addOnGpuAvailableListener(EventListener<GpuEventInfo> listener) {
        return this;
    }
    ...
    @Override
    public Videocard setGpuSearchRetryDelay(double delay) {
        return this;
    }

    @Override
    public boolean processVGpuCreate(VGpu vgpu) {
        return false;
    }

    @Override
    public String processVGpuDestroy(VGpu vgpu) {
    ...
    @Override
    public void gpusProcessActivation(boolean activate) { /**/ }

    @Override
    public void gpuProcessActivation(Gpu gpu, boolean activate) { /**/ }
